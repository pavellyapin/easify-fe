...
@Component({
  selector: 'app-workout-search-box',
  standalone: true,
  imports: [MatFormFieldModule, MatIconModule, MatInputModule],
  templateUrl: './workout-search-box.component.html',
  styleUrl: './workout-search-box.component.scss',
})
export class WorkoutSearchBoxComponent {
  constructor(
    private store: Store,
