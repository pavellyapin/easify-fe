...
@Component({
  selector: 'app-course-category-autocomplete',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './course-category-autocomplete.component.html',
  styleUrl: './course-category-autocomplete.component.scss',
})
export class CourseCategoryAutocompleteComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Fetch all course categories on initialization
    this.coursesService.getAllCourseCategories().subscribe((categories) => {
